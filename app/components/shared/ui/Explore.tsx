...
const Explore = () => {
  ...
  return (
    <section className="relative w-full max-w-[1294px] h-[550px] bg-[#F8F9FA] rounded-2xl flex items-center justify-between px-14 overflow-hidden transition-all duration-500">
